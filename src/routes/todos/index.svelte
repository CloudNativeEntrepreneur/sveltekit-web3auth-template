<script context="module" lang="ts">
  import { graphQLClient } from "sveltekit-web3auth/graphQL/urql";
  import {
    setClient,
    operationStore,
    subscription,
  ...
  // you'd probably use normal sveltekit-web3auth/config here, but if I did it'd be part of the package
  ...
  import { WEB3AUTH_CONTEXT_CLIENT_PROMISE } from "sveltekit-web3auth/web3auth/Web3Auth.svelte";
